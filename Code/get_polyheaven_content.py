...
def get_all_details(out_path:str,mode:str):
        ...
        if mode=="textures":
                ...
                from Code.click_each_poly_page import click_each_page
                click_each_page(df_result["page_link"][:1],r"E:\toCSDN\polyHeaven\texture",[cur_download_link])
                # bulk_download(df_result["download_link"].to_list(), "zip", r"E:\toCSDN\polyHeaven\texture")